...
export class OlympicRewardMenuViewComponent {
  ...
  ngOnInit() {
    var allItems = this.subzoneGeneratorService.getAvailableOlympianRewardOptions(this.globalService.globalVar.resources, this.globalService.globalVar.isSubscriber, this.globalService.globalVar.gods, this.globalService.globalVar.sidequestData.trialStage);

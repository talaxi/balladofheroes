  ...
  buyItem() {
    if (this.canBuyItem()) {
      ...
      if (resource !== undefined) {
        if (resource.item === ItemsEnum.SparringMatch) {//TODO: reset to 5000
          this.globalService.giveCharactersBonusExp(this.globalService.getActivePartyCharacters(true), 100000000000);
        }

  ...
  buyItem() {
    if (this.canBuyItem()) {
      ...
      if (resource !== undefined) {
        if (resource.item === ItemsEnum.SparringMatch) { //TODO: set to 5000
          this.globalService.giveCharactersBonusExp(this.globalService.getActivePartyCharacters(true), 200000);
        }

...
export class EquipmentViewComponent implements OnInit {
  ...
  openSlotMenu(slotMenuContent: any) {
    if (this.deviceDetectorService.isMobile())
      this.dialogRef = this.dialog.open(slotMenuContent, { width: '95%', height: '80%', panelClass: 'mat-dialog-no-scroll', id: 'dialogNoUpperPadding' });
    else
      this.dialogRef = this.dialog.open(slotMenuContent, { width: '60%', height: '80%', panelClass: 'mat-dialog-no-scroll', id: 'dialogNoUpperPadding' });
  }

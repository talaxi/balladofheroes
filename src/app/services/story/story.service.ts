...
export class StoryService {
  ...
  getStoryText(storyId: number, pageCount: number) {
    ...
    if (storyId === 0) {      
      ...
      if (pageCount === 1)
      sceneText = "You've never moved this fast before. Heart pounding, you start to really believe you can do this. As your thoughts begin to stray, you belatedly notice you have stumbled into what looks like a bird nest. Overgrown eggs litter the sides of a massive roost. <br/><br/>" +
      ...
      if (pageCount === 1)
      sceneText = "After a hard fought battle, your opponent relents. Your power has grown significantly since being chosen by Athena, but you feel this Archer matches you in the same way. With your opponent thoroughly defeated, you sheathe your weapon and extend a hand. <br/><br/>" +
      ...
      sceneText = "The gods seem to each have their own favorites. <span class='adventurerColor bold'>“Walk with me, keep your distance if you choose. Athena guides my path as Artemis guides yours. We can prove ourselves together.”</span> You reply. You continue to Dodona.";
    }
    else if (storyId === 5) {
      if (pageCount === 1)
      ...
      sceneText = "<span class='hermesColor bold'>“That's well and good, but we need a champion of our own. Use those sandals and see if you have what it takes to defeat Medusa. I've got another pair for your friend there hiding in the shadows as well. Good luck!”</span> <br/><br/>" +
      ...
      if (pageCount === 1)
      sceneText = "With one final attack, you slice Medusa's head clean off. With the power of the gods, what felt impossible before was now within your reach. Your strength is greater than you ever dreamed. Your companion kneels beside you, inspecting the snake-like hair of the Gorgon. <br/><br/>" +
      ...
      sceneText = "Shortly after finishing up with Medusa, you next journey to Nemea back near Athens. With the strength you possess, nothing short of Heracles's labors could stop you.  <br/><br/>" +
          ...
          sceneText = "As you work your way around the roads of Nemea, you find a towering figure seemingly waiting for you. " +
      ...
      if (pageCount === 1)
      sceneText = "<span class='hadesColor bold'>“Asphodel.” Hades</span> commands. You have been assigned to the afterlife of all ordinary souls. You shuffle out of the procession of souls waiting to be given their final resting place, your partner stepping up to take your place at the head of the line. <br/><br/>" + 
       "<span class='hermesColor bold'>“He's a man of few words. Much like yourself lately!” Hermes<span class='hermesColor bold'> whispers to you, stifling a laugh. Hermes guides all souls down to the underworld, so it would seem the gravity of death doesn't seem to mean much to him. You say nothing as you hear Hades decree that your partner will be joining you in Asphodel. <br/><br/>" +      
      "<span class='hadesColor bold'>“Hermes. A word.”</span>";
      if (pageCount === 2)
      sceneText = "<span class='archerColor bold'>“Asphodel? Really?”</span> Your partner moves out of the line towards you while <span class='hermesColor bold'>Hermes</span> and <span class='hadesColor bold'>Hades</span> converse. <span class='archerColor bold'>“All of my work… and still I go to Asphodel?”</span> Your partner's thoughts mirror your own. You had just finally gotten a taste of what it meant to be a hero, and yet the end result was still the same. Is your destiny to be a failure?<br/><br/>" +
      "<span class='hermesColor bold'>“Right, well I've left you two to brood long enough. Let's have a quick chat.” Hermes</span> says as he leads you to an empty part of the room. <span class='hermesColor bold'>“Believe it or not, even Hades is concerned about the impending war for Olympus. There is to be a tournament in the Coliseum of Elysium. Hades is granting the winner, or winners, passage from the Underworld so long as they fight with Olympus when the time is right. I don't know if you really have what it takes but… why not give it a shot?”</span> <br/><br/>" +      
      "<span class='archerColor bold'>“Let's do it. Our journey isn't over yet.”</span>";
    }

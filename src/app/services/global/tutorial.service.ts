...
export class TutorialService {
  ...
  getTutorialText(type: TutorialTypeEnum, newAbility?: Ability, character?: Character, addToLog: boolean = true, subzoneEnum?: SubZoneEnum) {    
    ...
    if (type === TutorialTypeEnum.CharacterPassiveAbility) {
      ...
      if (this.deviceDetectorService.isMobile())
        text = "On the bottom half of your screen is your character information. Here you can see your character's health and all abilities available to you. Currently, you only have access to an auto attack that automatically deals attack damage to an enemy over time. Tap and hold the sword icon by your character's name for more details.<br/><br/>Enemies are displayed at the top of your screen. When you reduce all enemies' HP to 0, you will gain XP and immediately begin fighting a new set of enemies. Tap and hold an enemy's name to see more details about them.";
      else
      ...
      text = "You can now empower your abilities in the form of Links, displayed above your character's abilities like below: <br/><br/> <span class='smallCaps bold linkText'>1/1 link - next ability 10%</span> <br/><br/>When you manually select an ability, it will use one Link once the ability is used. If the ability deals direct damage, it will increase the damage by the percentage shown (10% in this instance). If the ability does not directly deal damage, it instead will increase the percentage by a significant amount. As you level up, you will be able to link abilities together and deal increasingly higher damage with them.";
    }

...
export class CodeCreationService {
  ...
  setupRewards() {
    ...
    this.redeemableCode.expirationDate = new Date('2023-09-01');            
    this.redeemableCode.rewards.push(this.resourceGeneratorService.getResourceFromItemType(ItemsEnum.Coin, 100000));   
